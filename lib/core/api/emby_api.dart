...
class EmbyApiClient implements ApiClientFactory {
  ...
  static Future<Response<T>> _withRetry<T>(Future<Response<T>> Function() send,
...
class EmbyLibraryApi implements LibraryApi {
  ...
  static const String _libraryItemFields =
      ...
      'ProviderIds,PresentationUniqueKey,Path,MediaSources,MediaStreams,'
      'ParentLogoItemId,ParentLogoImageTag,'
      'BackdropImageTags,ParentBackdropItemId,ParentBackdropImageTags';
...
class EmbySearchApi implements SearchApi {
  ...
  Future<List<MediaItem>> search(String query,
    ...
    final resp = await _client
        .get('/Users/$uid/Items', cancelToken: cancelToken, queryParameters: {
      'SearchTerm': query,
      'Recursive': recursive,
      'Limit': 50,
      'IncludeItemTypes': 'Movie,Series',
...
UserPolicy? _parseUserPolicy(dynamic raw) {
  ...
  return UserPolicy(
    ...
    enableDownloading: readBool('EnableDownloading') || readBool('EnableSync'),
  );
}
...
Episode _parseEpisode(Map<String, dynamic> d) {
  ...
  if (sources != null && sources.isNotEmpty) {
    ...
    if (videoResolution != null && videoResolution.isEmpty)
