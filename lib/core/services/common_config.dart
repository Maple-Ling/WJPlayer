...
class CommonConfig {
  ...
  static const String clientId = 'WJPlayer';
  static const String formatVersion = '1.0';
  static const _uuid = Uuid();

  /// WJPlayer 内置默认密钥(32B)。导出时同时写入 `_key`,所以即便对方没有这把
  /// 内置密钥也能解;它主要作为「文件未带 `_key`」时的回退。
  static const List<int> _builtinKey = [
    0x4c, 0x69, 0x6e, 0x50, 0x6c, 0x61, 0x79, 0x65, // "WJPlayer"
  ...
  /// [extra] 写入 `additional_data`(明文,放 WJPlayer 偏好等无密内容)。
  ...
  /// 读取容器里的 `additional_data`(WJPlayer 偏好等),无则返回 null。
