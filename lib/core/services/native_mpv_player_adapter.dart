...
class NativeMpvPlayerAdapter implements PlayerAdapter {
  static const _channel = MethodChannel('com.mapleling.wjplayer/mpv');
  ...
  Future<void> initialize({
    ...
    try {
      ...
      _eventChannel = EventChannel('com.mapleling.wjplayer/mpv/events/$_playerId');
  ...
  bool get isSoftwareTexture => false;
