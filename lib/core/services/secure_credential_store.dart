...
class SecureCredentialStore {
  ...
  static const _serversPrefsKey = 'wjplayer_servers';
  static const _fallbackPrefsKey = 'wjplayer_server_secrets_fb';
  static const _kvFallbackPrefsKey = 'wjplayer_kv_secrets_fb';
  static const _fbPassphrase = 'WJPlayer::server::cred::fallback::v1';

  /// 启动时把这些旧明文 prefs 字符串键迁移进加密 KV（如翻译引擎 API key，M5）。
  static const _legacyKvKeys = <String>[
    'wjplayer_trans_openai',
    'wjplayer_trans_anthropic',
    'wjplayer_trans_baidu_general',
    'wjplayer_trans_baidu_llm',
    'wjplayer_trans_tencent',
  ];
