...
final translationEngineKindProvider =
  ...
  return PreferenceNotifier<TranslationEngineKind>(
    ...
    readValue: (prefs) =>
        TranslationEngineKind.fromKey(prefs.getString('wjplayer_trans_engine')),
    writeValue: (prefs, value) async {
      await prefs.setString('wjplayer_trans_engine', value.storageKey);
    },
  );
});
...
final translationTargetLangProvider =
  ...
  return PreferenceNotifier<String>(
    defaultValue: 'zh',
    readValue: (prefs) => prefs.getString('wjplayer_trans_target'),
    writeValue: (prefs, value) async {
      await prefs.setString('wjplayer_trans_target', value);
    },
  );
});
...
final bilingualLayoutProvider =
  ...
  return PreferenceNotifier<BilingualLayout>(
    ...
    readValue: (prefs) {
      final v = prefs.getString('wjplayer_trans_layout');
      return BilingualLayout.values
          .firstWhere((e) => e.name == v, orElse: () => BilingualLayout.translatedFirst);
    },
    writeValue: (prefs, value) async {
      await prefs.setString('wjplayer_trans_layout', value.name);
    },
  );
});
...
final openAiConfigProvider =
    StateNotifierProvider<PreferenceNotifier<AiEngineConfig>, AiEngineConfig>(
        (ref) => _aiNotifier('wjplayer_trans_openai', AiEngineConfig.openaiDefault));

final anthropicConfigProvider =
    StateNotifierProvider<PreferenceNotifier<AiEngineConfig>, AiEngineConfig>(
        (ref) =>
            _aiNotifier('wjplayer_trans_anthropic', AiEngineConfig.anthropicDefault));
...
final baiduGeneralConfigProvider = StateNotifierProvider<
  ...
  (ref) => _baiduNotifier('wjplayer_trans_baidu_general'),
);

final baiduLlmConfigProvider = StateNotifierProvider<
    PreferenceNotifier<BaiduEngineConfig>, BaiduEngineConfig>(
  (ref) => _baiduNotifier('wjplayer_trans_baidu_llm'),
);
...
final tencentConfigProvider = StateNotifierProvider<
  ...
  return PreferenceNotifier<TencentEngineConfig>(
    ...
    readValue: (_) {
      final s = SecureCredentialStore.instance.readKv('wjplayer_trans_tencent');
      if (s == null) return null;
      try {
    ...
    writeValue: (_, value) async {
      await SecureCredentialStore.instance
          .writeKv('wjplayer_trans_tencent', jsonEncode(value.toJson()));
    },
  );
});
...
final whisperEnabledProvider =
  ...
  return PreferenceNotifier<bool>(
    defaultValue: false,
    readValue: (prefs) => prefs.getBool('wjplayer_whisper_enabled'),
    writeValue: (prefs, value) async {
      await prefs.setBool('wjplayer_whisper_enabled', value);
    },
  );
});
...
final whisperModelProvider =
  ...
  return PreferenceNotifier<WhisperModel>(
    ...
    readValue: (prefs) =>
        WhisperModel.fromKey(prefs.getString('wjplayer_whisper_model')),
    writeValue: (prefs, value) async {
      await prefs.setString('wjplayer_whisper_model', value.storageKey);
    },
  );
});
...
final whisperMirrorProvider =
  ...
  return PreferenceNotifier<String>(
    defaultValue: '',
    readValue: (prefs) => prefs.getString('wjplayer_whisper_mirror'),
    writeValue: (prefs, value) async {
      await prefs.setString('wjplayer_whisper_mirror', value);
    },
  );
});
...
final whisperBinaryPathProvider =
  ...
  return PreferenceNotifier<String>(
    defaultValue: '',
    readValue: (prefs) => prefs.getString('wjplayer_whisper_binary'),
    writeValue: (prefs, value) async {
      await prefs.setString('wjplayer_whisper_binary', value);
    },
  );
});
...
final ffmpegPathProvider =
  ...
  return PreferenceNotifier<String>(
    defaultValue: '',
    readValue: (prefs) => prefs.getString('wjplayer_ffmpeg_path'),
    writeValue: (prefs, value) async {
      await prefs.setString('wjplayer_ffmpeg_path', value);
    },
  );
});
