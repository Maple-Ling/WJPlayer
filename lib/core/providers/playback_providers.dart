  ...
  return PreferenceNotifier<String>(
    ...
    writeValue: (prefs, value) async {
      await prefs.setString(
          'wjplayer_player_core', normalizePlayerCore(value));
    },
  );
});
...
final backgroundPlaybackProvider =
  ...
  return PreferenceNotifier<bool>(
    defaultValue: true,
    readValue: (prefs) => prefs.getBool('wjplayer_background_playback'),
    writeValue: (prefs, value) async {
...
final watchedThresholdProvider =
  ...
  return PreferenceNotifier<int>(
    defaultValue: 90,
    readValue: (prefs) =>
        normalize(prefs.getInt('wjplayer_watched_threshold')),
    writeValue: (prefs, value) async {
      await prefs.setInt(
...
final preferredSubtitleLanguageProvider =
  ...
  return PreferenceNotifier<String>(
    defaultValue: 'chi',
    readValue: (prefs) =>
        prefs.getString('wjplayer_preferred_subtitle_language'),
    writeValue: (prefs, value) async {
...
final exoLibassProvider =
  ...
  return PreferenceNotifier<bool>(
    defaultValue: false,
    readValue: (prefs) => prefs.getBool('wjplayer_exo_libass'),
    writeValue: (prefs, value) async {
